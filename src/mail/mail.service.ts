  ...
  async sendForgotEmailPassword(data: ForgotPasswordEmailDto) {
    try {
      await this.resend.emails.send({
        from: 'no-reply@casadeapoio.org.br',
        to: data.email,
        subject: 'Casa de Apoio - Sua solicitação para alterar a senha',
              ...
              <tr style="width:100%">
                <td>
                  <table style="margin-top:32px" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
                    <tbody>
                      <tr>
                        <td><img alt="Casa de apoio logo" src="https://raw.githubusercontent.com/Arndt-Samuel/allegre-frontend/main/public/Logo.png" width="100" height="100" style="display:block;outline:none;border:none;text-decoration:none" /></td>
                      </tr>
                    </tbody>
                  </table>
                        ...
                        <td>
                          <table width="100%" style="margin-bottom:32px;padding-left:8px;padding-right:8px;width:100%" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                            <tbody style="width:100%">
                              <tr style="width:100%">
                                <td style="width:66%"><img alt="Casa de apoio logo" src="https://raw.githubusercontent.com/Arndt-Samuel/allegre-frontend/main/public/Logo.png" width="100" height="100" style="display:block;outline:none;border:none;text-decoration:none" /></td>
                                <td>
                  ...
                  <table align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
                    <tbody>
                      <tr>
                          ...
                          <p style="font-size:12px;line-height:15px;margin:16px 0;color:#b7b7b7;text-align:left;margin-bottom:50px">©2024 Casa de Apoio<br /><br /><br />All rights reserved.</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
